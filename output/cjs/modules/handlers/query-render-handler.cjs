...
var require_templates = __commonJS({
  "node_modules/chalk/source/templates.cjs"(exports2, module2) {
    ...
    function buildStyle(chalk11, styles4) {
      const enabled = {};
    ...
    module2.exports = (chalk11, temporary) => {
      ...
      temporary.replace(TEMPLATE_REGEX, (m, escapeCharacter, inverse, style, close, character) => {
        if (escapeCharacter) {
          ...
          chunk = [];
          chunks.push(styles4.length === 0 ? string : buildStyle(chalk11, styles4)(string));
          styles4.push({ inverse, styles: parseStyle(style) });
        } else if (close) {
          if (styles4.length === 0) {
            throw new Error("Found extraneous } in Chalk template literal");
          }
          chunks.push(buildStyle(chalk11, styles4)(chunk.join("")));
          chunk = [];
          styles4.pop();
        } else {
...
var require_source = __commonJS({
  "node_modules/chalk/source/index.cjs"(exports2, module2) {
    ...
    var chalk11 = Chalk();
    chalk11.supportsColor = stdoutColor2;
    chalk11.stderr = Chalk({ level: stderrColor2 ? stderrColor2.level : 0 });
    chalk11.stderr.supportsColor = stderrColor2;
...
module.exports = __toCommonJS(query_render_handler_exports);
...
var chalkFactory = (options) => {
  const chalk11 = (...strings) => strings.join(" ");
  applyOptions(chalk11, options);
  Object.setPrototypeOf(chalk11, createChalk.prototype);
  return chalk11;
};
...
var getGenerators = (prismaState, data) => {
  ...
  const result = sections.map((section) => {
    return boxen(import_chalk9.default.bold(section.name) + "\n" + section.table, { padding: 1, borderStyle: "bold" });
  }).join("\n");
...
var getDB = (prismaState, data) => {
  ...
  return response.result(boxen(`${import_chalk10.default.gray("Provider")}: ${provider}
${import_chalk10.default.gray("URL")}: ${prevUrl}`, { padding: 1, textAlignment: "left", margin: 1, borderStyle: "double" }));
};
