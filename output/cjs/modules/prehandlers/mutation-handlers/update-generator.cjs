...
var update_generator_exports = {};
__export(update_generator_exports, {
  normalizeQuotes: () => normalizeQuotes,
  updateGenerator: () => updateGenerator
});
module.exports = __toCommonJS(update_generator_exports);
...
var updateGenerator = (prismaState, data) => {
  ...
  if (prismaBlock) {
    ...
    console.log(import_chalk.default.yellow(`Warning: generator block provided. Generator ${generatorName} will be replaced`));
    ...
    if (otherOptions.length) {
      console.log(import_chalk.default.yellow(`Warning: unknown options ${otherOptions.join(", ")} will be skipped`));
      const validOptions = ["output", "provider", "binaryTargets"];
      console.log(import_chalk.default.yellow(`Valid options are: ${validOptions.join(", ")}`));
    }
    if (options?.output) {
