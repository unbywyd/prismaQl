...
var get_db_exports = {};
__export(get_db_exports, {
  getDB: () => getDB,
  normalizeQuotes: () => normalizeQuotes
});
module.exports = __toCommonJS(get_db_exports);
...
var getDB = (prismaState, data) => {
  ...
  return response.result(boxen(`${import_chalk2.default.gray("Provider")}: ${provider}
${import_chalk2.default.gray("URL")}: ${prevUrl}`, { padding: 1, textAlignment: "left", margin: 1, borderStyle: "double" }));
};
