...
var get_models_exports = {};
__export(get_models_exports, {
  getModels: () => getModels
});
module.exports = __toCommonJS(get_models_exports);
...
var getModels = (prismaState, data) => {
  ...
  const title = modelCount > 0 ? `\u{1F4CA} Query Result: ${import_chalk2.default.bold(modelCount)} model${modelCount > 1 ? "s" : ""} found:` : `\u274C No models found`;
  const highlightedSchema = highlightPrismaSchema.highlight((0, import_prisma_ast.printSchema)(schema));
