...
module.exports = __toCommonJS(prisma_ql_provider_exports);
...
var PrismaQlProvider = class {
  ...
  async dryMutation(input) {
    ...
    try {
      ...
      console.log("\u2705", import_chalk2.default.gray(displayCommand), import_chalk2.default.green(`Dry run success!`));
    } catch (e) {
    ...
    console.log("\u2705", import_chalk2.default.gray(displayCommand), import_chalk2.default.green(`Validation success!`));
  ...
  async mutation(input, options = {}) {
    ...
    try {
      ...
      const displayCommand = `${parsedCommand.action} ${parsedCommand.command} > `;
      console.log("\u2705", import_chalk2.default.white(displayCommand), import_chalk2.default.green("Mutation success"));
    } catch (e) {
      throw new Error(`Modification failed: ${e.message}`);
    }
    if (options.save) {
