...
export declare class PrismaQlFieldRelationLogger {
...
export declare const getRelationStatistics: (relations: PrismaQLRelation[], modelName: string, maxDepth?: number) => PrismaQLRelationStatistics;
//# sourceMappingURL=field-relation-logger.d.ts.map