 ...
 */
export function detectOneToOneRelations(models: Model[]): Relation[] {
...
export function detectOneToManyRelations(models: Model[]): Relation[] {
    const relations: Relation[] = [];
...
export function detectManyToManyRelations(models: Model[]): Relation[] {
    const relations: Relation[] = [];
...
export function detectExplicitManyToManyRelations(models: Model[]): Relation[] {
    const relations: Relation[] = [];
...
async function parsePrismaSchema(schema: string): Promise<Relation[]> {
...
export function buildModelTrees(
    rootModel: string,
    relations: Relation[],
    maxDepth: number,
    depth = 0,
...
export function collectRelationStatistics(models: Set<string>, relations: Set<string>, maxDepth: number) {
    return {
...
export async function generateRelationTree(
    rootModel: string,
